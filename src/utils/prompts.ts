...
const getEventContextualizationPrompt = (
  agent_capabilities: string,
  ads_event_payload: ADSDataPayload
) => {
  const prompt = `
                    ...
                    Here are the details you will use to generate the prompt:
                        <EVENT_NAME>${ads_event_payload.event_name}</EVENT_NAME>
                                                
                        <EVENT_DESCRIPTION>${
                          ads_event_payload.event_description
                        }</EVENT_DESCRIPTION>
                                                
                        <EVENT_DATA>${JSON.stringify(
                          ads_event_payload.event_data
                        )}</EVENT_DATA>
                                                
                        <AGENT_DESCRIPTION>${agent_capabilities}</AGENT_DESCRIPTION>
...
export { getEventContextualizationPrompt };
